...
void Ground::MakeGround(SDL_Renderer* screen)
{
    ...
    {
        SetupGround("assets//ground//center.png", SCREEN_WIDTH, Center, screen);
    }

    if (myRandomHoleGround!=0)
    {
        SetupGround("assets//ground//right.png", SCREEN_WIDTH, Right, screen);
        for (int i=0; i < myRandomHoleGround; i++)
        {
            SetupGround("assets//ground//hole.png", SCREEN_WIDTH, Hole, screen);
        }
        SetupGround("assets//ground//left.png", SCREEN_WIDTH, Left, screen);
    }
}
...
void Ground::MakeStartGround(SDL_Renderer* screen)
{
    ...
    {
        SetupGround("assets//ground//center.png", i*GroundSize, Center, screen);
    }
}
